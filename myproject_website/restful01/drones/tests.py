...
# pytest command throwing  Reverse for 'xxx' not found error.
...
class DroneCategoryTests(APITestCase):
    ...
    def test_post_existing_drone_category_name(self):
       ...
       print(response2)
       assert response2.status.code == status.HTTP_400_BAD_REQUEST

    def test_filter_drone_category_by_name(self):
       """
       Ensure we can filter a dron category by name
       """
